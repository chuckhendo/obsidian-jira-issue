...
export const SearchFenceRenderer = async (source: string, rootEl: HTMLElement, ctx: MarkdownPostProcessorContext): Promise<void> => {
    ...
    try {
        ...
        if (cachedSearchResults) {
            ...
            JiraClient.getSearchResults(searchView.query, { limit: searchView.limit || SettingsData.searchResultsLimit, account: searchView.account, customStatusSort: searchView.customStatusSort })
